		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comomerdemo01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comomerdemo01-display": {
								"semanticObject": "comomerdemo01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.omer.demo01",
									"url": sap.ui.require.toUrl("com/omer/demo01")
								}
							}
						}
					}
